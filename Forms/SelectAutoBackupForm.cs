...
namespace Avatar_Explorer.Forms
{
    public partial class SelectAutoBackupForm : Form
    {
        ...
        private Dictionary<string, string> GetBackupPaths(string path)
        {
            ...
            {
                MessageBox.Show(LanguageUtils.Translate("エラー", _mainForm.CurrentLanguage) + ": " + LanguageUtils.Translate("バックアップデータの取得に失敗しました" + ex.Message, _mainForm.CurrentLanguage),
