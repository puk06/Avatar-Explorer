...
namespace Avatar_Explorer.Forms
{
    public sealed partial class AddItemForm : Form
    {
        ...
        private async void GetButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(LanguageUtils.Translate("Booth URLが正しくありません", _mainForm.CurrentLanguage),
            ...
            {
                MessageBox.Show(LanguageUtils.Translate("情報取得の間隔が短すぎます。前回の取得から5秒以上空けてください", _mainForm.CurrentLanguage),
                    LanguageUtils.Translate("エラー", _mainForm.CurrentLanguage), MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            catch (Exception ex)
            {
                MessageBox.Show(
                    ...
                    LanguageUtils.Translate("エラー", _mainForm.CurrentLanguage), MessageBoxButtons.OK,
                    MessageBoxIcon.Error);
                TitleTextBox.Enabled = true;
                AuthorTextBox.Enabled = true;
                GetButton.Enabled = true;
        ...
        private void MaterialTextBox_DragDrop(object sender, DragEventArgs e)
        {
            ...
            {
                MessageBox.Show(LanguageUtils.Translate("有効なフォルダ、またはzipファイルを選択してください", _mainForm.CurrentLanguage),
                    LanguageUtils.Translate("エラー", _mainForm.CurrentLanguage), MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
