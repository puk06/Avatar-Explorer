    ...
    public sealed partial class MainForm : Form
    {
        ...
        private void GenerateAvatarList()
        {
            ...
            foreach (Item item in items)
            {
                ...
                Button button = AEUtils.CreateButton(item.ImagePath, item.Title,
                    LanguageUtils.Translate("作者: ", CurrentLanguage) + item.AuthorName, true,
                ...
                if (item.BoothId != -1)
                {
                    ToolStripMenuItem toolStripMenuItem =
                        new(LanguageUtils.Translate("Boothリンクのコピー", CurrentLanguage),
                    ...
                    ToolStripMenuItem toolStripMenuItem1 =
                        new(LanguageUtils.Translate("Boothリンクを開く", CurrentLanguage),
                            SharedImages.GetImage(SharedImages.Images.CopyIcon));
                ...
                ToolStripMenuItem toolStripMenuItem2 = new(LanguageUtils.Translate("この作者の他のアイテムを表示", CurrentLanguage),
                ...
                ToolStripMenuItem toolStripMenuItem3 = new(LanguageUtils.Translate("サムネイル変更", CurrentLanguage),
                ...
                EventHandler clickEvent5 = (_, _) =>
                {
                    ...
                    MessageBox.Show(
                        ...
                        LanguageUtils.Translate("完了", CurrentLanguage), MessageBoxButtons.OK, MessageBoxIcon.Information);
                ...
                ToolStripMenuItem toolStripMenuItem4 = new(LanguageUtils.Translate("編集", CurrentLanguage),
                    SharedImages.GetImage(SharedImages.Images.EditIcon));
                ...
                ToolStripMenuItem toolStripMenuItem5 = new(LanguageUtils.Translate("メモの追加", CurrentLanguage),
                    SharedImages.GetImage(SharedImages.Images.EditIcon));
                ...
                ToolStripMenuItem toolStripMenuItem6 = new(LanguageUtils.Translate("削除", CurrentLanguage),
                    SharedImages.GetImage(SharedImages.Images.TrashIcon));
                EventHandler clickEvent8 = (_, _) =>
                {
                    DialogResult result = MessageBox.Show(LanguageUtils.Translate("本当に削除しますか？", CurrentLanguage),
                        LanguageUtils.Translate("確認", CurrentLanguage), MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                    ...
                    if (item.Type == ItemType.Avatar)
                    {
                        ...
                        DatabaseUtils.DeleteAvatarFromItem(ref Items, item.ItemPath, result2 == DialogResult.Yes);
                    ...
                    MessageBox.Show(LanguageUtils.Translate("削除が完了しました。", CurrentLanguage),
                        LanguageUtils.Translate("完了", CurrentLanguage), MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void GenerateAuthorList()
        {
            ...
            {
                Button button = AEUtils.CreateButton(author.AuthorImagePath, author.AuthorName,
                    Items.Count(item => item.AuthorName == author.AuthorName) +
                    LanguageUtils.Translate("個の項目", CurrentLanguage), true, author.AuthorName, GetAvatarListWidth);
                button.Location = new Point(0, (70 * index) + 2);
                EventHandler clickEvent = (_, _) =>
                {
                    CurrentPath = new CurrentPath
                ...
                ToolStripMenuItem toolStripMenuItem = new(LanguageUtils.Translate("サムネイル変更", CurrentLanguage),
                    SharedImages.GetImage(SharedImages.Images.EditIcon));
        ...
        private void GenerateCategoryListLeft()
        {
            ...
            foreach (ItemType itemType in Enum.GetValues<ItemType>())
            {
                ...
                Button button = AEUtils.CreateButton(null,
                    ItemUtils.GetCategoryName(itemType, CurrentLanguage),
                    itemCount + LanguageUtils.Translate("個の項目", CurrentLanguage), true, "", GetAvatarListWidth);
                button.Location = new Point(0, (70 * index) + 2);
                EventHandler clickEvent = (_, _) =>
                {
                    CurrentPath = new CurrentPath
            ...
            if (CustomCategories.Count != 0)
            {
                foreach (var customCategory in CustomCategories)
                {
                    ...
                    Button button = AEUtils.CreateButton(null, customCategory,
                        itemCount + LanguageUtils.Translate("個の項目", CurrentLanguage), true, "", GetAvatarListWidth);
                    button.Location = new Point(0, (70 * index) + 2);
                    EventHandler clickEvent = (_, _) =>
                    {
            ...
            foreach (ItemType itemType in Enum.GetValues<ItemType>())
            {
                ...
                else
                {
                    itemCount = Items.Count(item =>
                        item.Type == itemType &&
                        (
                            ItemUtils.IsSupportedAvatarOrCommon(item, CommonAvatars, CurrentPath.CurrentSelectedAvatarPath)
                                .IsSupportedOrCommon ||
                            item.SupportedAvatar.Count == 0 || CurrentPath.CurrentSelectedAvatar == "*"
                        )
                    );
                }
                ...
                Button button = AEUtils.CreateButton(null,
                    ItemUtils.GetCategoryName(itemType, CurrentLanguage),
                    itemCount + LanguageUtils.Translate("個の項目", CurrentLanguage), false, "", GetItemExplorerListWidth);
                button.Location = new Point(0, (70 * index) + 2);
        ...
        private void GenerateItems()
        {
            ...
            filteredItems = SortingBox.SelectedIndex switch
            {
                ...
                {
                    return ItemUtils.ContainsSelectedAvatar(item, CurrentPath.CurrentSelectedAvatarPath) ? 0 : 1;
                }),
                5 => filteredItems.OrderBy(item =>
                {
                    return ItemUtils.ContainsSelectedAvatar(item, CurrentPath.CurrentSelectedAvatarPath) ? 1 : 0;
                }),
            ...
            foreach (Item item in filteredItems)
            {
                ...
                if (isSupportedOrCommon.OnlyCommon && item.SupportedAvatar.Count != 0 &&
                ...
                Button button = AEUtils.CreateButton(item.ImagePath, item.Title, authorText, false, description,
                ...
                EventHandler clickEvent = (_, _) =>
                {
                    if (!Directory.Exists(item.ItemPath))
                    {
                        var prePath = item.ItemPath;
                        DialogResult result =
                            MessageBox.Show(LanguageUtils.Translate("フォルダが見つかりませんでした。編集しますか？", CurrentLanguage),
                                LanguageUtils.Translate("エラー", CurrentLanguage), MessageBoxButtons.YesNo,
                ...
                if (Directory.Exists(item.ItemPath))
                {
                    ToolStripMenuItem toolStripMenuItem = new(LanguageUtils.Translate("フォルダを開く", CurrentLanguage),
                        SharedImages.GetImage(SharedImages.Images.OpenIcon));
                ...
                ToolStripMenuItem toolStripMenuItem6 = new(LanguageUtils.Translate("実装/未実装", CurrentLanguage),
                    SharedImages.GetImage(SharedImages.Images.EditIcon));
                ...
                ToolStripMenuItem toolStripMenuItem7 = new(LanguageUtils.Translate("削除", CurrentLanguage),
                    SharedImages.GetImage(SharedImages.Images.TrashIcon));
        ...
        private void GenerateItemCategoryList()
        {
            ...
            ItemFolderInfo itemFolderInfo = ItemUtils.GetItemFolderInfo(CurrentPath.CurrentSelectedItem.ItemPath,
            ...
            foreach (var itemType in types)
            {
                ...
                Button button = AEUtils.CreateButton(null,
                    LanguageUtils.Translate(itemType, CurrentLanguage), itemCount + LanguageUtils.Translate("個の項目", CurrentLanguage),
        ...
        private void GenerateItemFiles()
        {
            ...
            foreach (var file in files)
            {
                ...
                Button button = AEUtils.CreateButton(imagePath, file.FileName,
                    file.FileExtension.Replace(".", "") + LanguageUtils.Translate("ファイル", CurrentLanguage), false,
                    LanguageUtils.Translate("開くファイルのパス: ", CurrentLanguage) + file.FilePath, GetItemExplorerListWidth);
                button.Location = new Point(0, (70 * index) + 2);

                ContextMenuStrip contextMenuStrip = new();

                ToolStripMenuItem toolStripMenuItem = new(LanguageUtils.Translate("開く", CurrentLanguage),
                    SharedImages.GetImage(SharedImages.Images.CopyIcon));
                ...
                ToolStripMenuItem toolStripMenuItem1 = new(LanguageUtils.Translate("ファイルのパスを開く", CurrentLanguage),
                    SharedImages.GetImage(SharedImages.Images.CopyIcon));
        ...
        private void GenerateFilteredItem(SearchFilter searchFilter)
        {
            ...
            var filteredItems = Items.Where(item => DatabaseUtils.GetSearchResult(Items, item, searchFilter, CurrentLanguage));
            ...
            SearchResultLabel.Text = LanguageUtils.Translate("検索結果: ", CurrentLanguage) + filteredItems.Count() +
                                     LanguageUtils.Translate("件", CurrentLanguage) + LanguageUtils.Translate(" (全", CurrentLanguage) +
                                     Items.Count + LanguageUtils.Translate("件)", CurrentLanguage);
            if (!filteredItems.Any()) return;
            ...
            foreach (Item item in filteredItems)
            {
                ...
                Button button = AEUtils.CreateButton(item.ImagePath, item.Title,
                    LanguageUtils.Translate("作者: ", CurrentLanguage) + item.AuthorName, false,
                ...
                EventHandler clickEvent9 = (_, _) =>
                {
                    ...
                    if (item.Type == ItemType.Avatar)
                    {
                        ...
                        if (CommonAvatars.Any(commonAvatar => commonAvatar.Avatars.Contains(item.ItemPath)))
                        {
                            var result3 = MessageBox.Show(LanguageUtils.Translate("このアバターを共通素体グループから削除しますか？", CurrentLanguage),
                                LanguageUtils.Translate("確認", CurrentLanguage), MessageBoxButtons.YesNo,
        ...
        private void GenerateFilteredFolderItems(SearchFilter searchWords)
        {
            ...
            SearchResultLabel.Text = LanguageUtils.Translate("フォルダー内検索結果: ", CurrentLanguage) + filteredFileData.Count() +
                                     LanguageUtils.Translate("件", CurrentLanguage) + LanguageUtils.Translate(" (全", CurrentLanguage) +
                                     fileDatas.Count() + LanguageUtils.Translate("件)", CurrentLanguage);
        ...
        {
            var categoryName = ItemUtils.GetCategoryName(CurrentPath.CurrentSelectedCategory, CurrentLanguage, CurrentPath.CurrentSelectedCustomCategory);
            var prefix = LanguageUtils.Translate("アバター", CurrentLanguage) + " | ";
            ...
            if (_authorMode)
            {
                ...
                if (CurrentPath.CurrentSelectedCategory == ItemType.Unknown)
                    return prefix + AEUtils.RemoveFormat(CurrentPath.CurrentSelectedAuthor.AuthorName);

                if (CurrentPath.CurrentSelectedItem == null)
                    return prefix + AEUtils.GernerateSeparatedPath(
                        AEUtils.RemoveFormat(CurrentPath.CurrentSelectedAuthor.AuthorName),
                        categoryName
                    );
                ...
                if (CurrentPath.CurrentSelectedItemCategory == null)
                    return prefix + AEUtils.GernerateSeparatedPath(
                        AEUtils.RemoveFormat(CurrentPath.CurrentSelectedAuthor.AuthorName),
                        categoryName,
                        AEUtils.RemoveFormat(CurrentPath.CurrentSelectedItem.Title)
                    );
                ...
                return prefix + AEUtils.GernerateSeparatedPath(
                    ...
                    categoryName,
                    AEUtils.RemoveFormat(CurrentPath.CurrentSelectedItem.Title),
                    LanguageUtils.Translate(CurrentPath.CurrentSelectedItemCategory, CurrentLanguage)
                );
            }
            ...
            if (CurrentPath.CurrentSelectedAvatar == null) return LanguageUtils.Translate("ここには現在のパスが表示されます", CurrentLanguage);

            if (CurrentPath.CurrentSelectedCategory == ItemType.Unknown)
                return prefix + AEUtils.RemoveFormat(CurrentPath.CurrentSelectedAvatar);

            if (CurrentPath.CurrentSelectedItem == null)
                return prefix + AEUtils.GernerateSeparatedPath(
                    AEUtils.RemoveFormat(CurrentPath.CurrentSelectedAvatar),
                    categoryName
                );
        ...
        private void SearchItems()
        {
            ...
            {
                pathTextArr = pathTextArr.Append(LanguageUtils.Translate("作者", CurrentLanguage) + ": " + string.Join(", ", searchFilter.Author)).ToArray();
            }

            if (searchFilter.Title.Length != 0)
            {
                pathTextArr = pathTextArr.Append(LanguageUtils.Translate("タイトル", CurrentLanguage) + ": " +string.Join(", ", searchFilter.Title)).ToArray();
            }
            ...
            {
                pathTextArr = pathTextArr.Append(LanguageUtils.Translate("アバター", CurrentLanguage) + ": " +string.Join(", ", searchFilter.Avatar)).ToArray();
            }

            if (searchFilter.Category.Length != 0)
            {
                pathTextArr = pathTextArr.Append(LanguageUtils.Translate("カテゴリ", CurrentLanguage) + ": " +string.Join(", ", searchFilter.Category)).ToArray();
            }

            if (searchFilter.ItemMemo.Length != 0)
            {
                pathTextArr = pathTextArr.Append(LanguageUtils.Translate("メモ", CurrentLanguage) + ": " +string.Join(", ", searchFilter.ItemMemo)).ToArray();
            }

            if (searchFilter.FolderName.Length != 0)
            {
                pathTextArr = pathTextArr.Append(LanguageUtils.Translate("フォルダ名", CurrentLanguage) + ": " +string.Join(", ", searchFilter.FolderName)).ToArray();
            }

            if (searchFilter.FileName.Length != 0)
            {
                pathTextArr = pathTextArr.Append(LanguageUtils.Translate("ファイル名", CurrentLanguage) + ": " +string.Join(", ", searchFilter.FileName)).ToArray();
            }

            if (searchFilter.ImplementedAvatars.Length != 0)
            {
                pathTextArr = pathTextArr.Append(LanguageUtils.Translate("実装アバター", CurrentLanguage) + ": " +string.Join(", ", searchFilter.ImplementedAvatars)).ToArray();
            }

            pathTextArr = pathTextArr.Append(string.Join(", ", searchFilter.SearchWords)).ToArray();

            PathTextBox.Text = LanguageUtils.Translate("検索中... - ", CurrentLanguage) + string.Join(" / ", pathTextArr);
        }
        #endregion
        ...
        private void ExportButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var commonAvatarResult = MessageBox.Show(LanguageUtils.Translate("対応アバターの欄に共通素体グループのアバターも追加しますか？", CurrentLanguage), LanguageUtils.Translate("確認", CurrentLanguage), MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                ...
                MessageBox.Show(LanguageUtils.Translate("Outputフォルダにエクスポートが完了しました！\nファイル名: ", CurrentLanguage) + fileName,
                    LanguageUtils.Translate("完了", CurrentLanguage), MessageBoxButtons.OK,
                    MessageBoxIcon.Information);
                ExportButton.Enabled = true;
            }
            catch (Exception ex)
            {
                MessageBox.Show(LanguageUtils.Translate("エクスポートに失敗しました", CurrentLanguage),
                    LanguageUtils.Translate("エラー", CurrentLanguage), MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            try
            {
                ...
                MessageBox.Show(
                    LanguageUtils.Translate(
                        ...
                        CurrentLanguage) + fileName, LanguageUtils.Translate("完了", CurrentLanguage), MessageBoxButtons.OK,
                    MessageBoxIcon.Information);
                MakeBackupButton.Enabled = true;
            }
            catch (Exception ex)
            {
                MessageBox.Show(LanguageUtils.Translate("バックアップに失敗しました", CurrentLanguage),
                    LanguageUtils.Translate("エラー", CurrentLanguage), MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void LoadDataFromFolder()
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    if (!File.Exists(filePath))
                    {
                        MessageBox.Show(LanguageUtils.Translate("アイテムファイルが見つかりませんでした。", CurrentLanguage),
                            LanguageUtils.Translate("エラー", CurrentLanguage), MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                    else
                    {
                    ...
                    if (!File.Exists(filePath2))
                    {
                        MessageBox.Show(LanguageUtils.Translate("共通素体ファイルが見つかりませんでした。", CurrentLanguage),
                            LanguageUtils.Translate("エラー", CurrentLanguage), MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                    else
                    {
                    ...
                    if (!File.Exists(customCategoryPath))
                    {
                        MessageBox.Show(LanguageUtils.Translate("カスタムカテゴリーファイルが見つかりませんでした。", CurrentLanguage),
                            LanguageUtils.Translate("エラー", CurrentLanguage), MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                    else
                    {
        ...
        private void BackupTimeTitle()
        {
            ...
            timer.Tick += (_, _) =>
            {
                ...
                {
                    if (_lastBackupError)
                        Text = CurrentVersionFormText + " - " + LanguageUtils.Translate("バックアップエラー", CurrentLanguage);
                    return;
                }
                ...
                Text = CurrentVersionFormText +
                       $" - {LanguageUtils.Translate("最終自動バックアップ: ", CurrentLanguage) + minutes + LanguageUtils.Translate("分前", CurrentLanguage)}";
